...
if __name__ == "__main__":
    ...
    print("=" * 60)
    print("Type your messages to interact with the support agent.")
    print("Type 'quit' or 'exit' to end the conversation.")
    print("Type 'state' to see the current workflow state.")
    print("=" * 60)
    print()
    ...
    while True:
        ...
        if user_input.lower() == "state":
            ...
            print(f"\n📊 Current Step: {snapshot.values.get('current_step', 'warranty_collector')}")
            print(f"   Warranty Status: {snapshot.values.get('warranty_status', 'not set')}")
            print(f"   Issue Type: {snapshot.values.get('issue_type', 'not set')}\n")
            continue
