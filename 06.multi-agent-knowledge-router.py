...
if __name__ == "__main__":
    ...
    for step in workflow.stream({"query": query}):
        ...
        for node_name, node_output in step.items():
            ...
            if "classifications" in node_output:
                console.print("\n[bold green]📋 Classifications:[/bold green]")
                for c in node_output["classifications"]:
                    console.print(f"  [cyan]→[/cyan] [yellow]{c['source']}:[/yellow] {c['query']}")
    ...
    console.print(f"[bold green]✨ Workflow completed in {step_count} steps[/bold green]")
